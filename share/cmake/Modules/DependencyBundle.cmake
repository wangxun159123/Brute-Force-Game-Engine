...
MACRO(SETUP_BUNDLE_PATHS _BUNDLE_PATH)
	...
	SET(BOOST_ROOT "${_BUNDLE_PATH}/boost_1_49_0")
	...
	IF(CMAKE_CONFIGURATION_TYPES)
		SET(BoostLog_LIBRARIES
			debug ${BoostLog_LIBRARY_DIR}/boost_log_setup-${BJAM_MS_INTERFIX}-mt-gd-1_49.lib
			debug ${BoostLog_LIBRARY_DIR}/boost_log-${BJAM_MS_INTERFIX}-mt-gd-1_49.lib
			optimized ${BoostLog_LIBRARY_DIR}/boost_log_setup-${BJAM_MS_INTERFIX}-mt-1_49.lib
			optimized ${BoostLog_LIBRARY_DIR}/boost_log-${BJAM_MS_INTERFIX}-mt-1_49.lib
		)
	ELSE()
		IF(CMAKE_BUILD_TYPE STREQUAL "Debug")
			SET(BoostLog_LIBRARIES
				${BoostLog_LIBRARY_DIR}/boost_log_setup-${BJAM_MS_INTERFIX}-mt-gd-1_49.lib
				${BoostLog_LIBRARY_DIR}/boost_log-${BJAM_MS_INTERFIX}-mt-gd-1_49.lib
			)
		ELSE() # Release!
			SET(BoostLog_LIBRARIES
				${BoostLog_LIBRARY_DIR}/boost_log_setup-${BJAM_MS_INTERFIX}-mt-1_49.lib
				${BoostLog_LIBRARY_DIR}/boost_log-${BJAM_MS_INTERFIX}-mt-1_49.lib
			)
		ENDIF()
	ENDIF()
