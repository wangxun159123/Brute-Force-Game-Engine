...
MACRO(BFG_INIT_PACKAGE _PACKAGE_NAME _PACKAGE_VERSION)
	...
	LOG("--------------------------------")
	LOG("Definitions for package: ${BFG_PACKAGE_NAME}")
	LOG("------ Global definitions ------")
	LOG("  system : ${CMAKE_HOST_SYSTEM}")
	LOG("   build : ${CMAKE_BUILD_TYPE}")
	LOG("  prefix : ${CMAKE_INSTALL_PREFIX}")
	LOG("------ Project definitions ------")
	LOG("     bin : ${BFG_BIN_DIR}")
	LOG("     lib : ${BFG_LIB_DIR}")
	LOG(" include : ${BFG_INCLUDE_DIR}")
	LOG("    data : ${BFG_DATA_DIR}")
	LOG("    conf : ${BFG_CONF_DIR}")
	LOG("  locale : ${BFG_LOCALE_DIR}")
	LOG("     doc : ${BFG_DOC_DIR}")
	LOG("----- Package specific ----- ")
	LOG("     bin : ${BFG_PACKAGE_BIN_DIR}")
	LOG(" include : ${BFG_PACKAGE_INCLUDE_DIR}")
	LOG("     doc : ${BFG_PACKAGE_DOC_DIR}")
